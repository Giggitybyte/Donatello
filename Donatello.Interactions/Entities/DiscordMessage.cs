...
namespace Donatello.Interactions.Entities
{
    ...
    public sealed class DiscordMessage : DiscordEntity
    {
        ...
        public DiscordUser Author => new(this.Json.GetProperty("author"));
        ...
        public ReadOnlyList<DiscordUser> MentionedUsers => new(this.Json.GetProperty("mentions").ToEntityArray<DiscordUser>());

        /// <summary>A collection of roles that were mentioned in this message.</summary>
        public ReadOnlyList<DiscordRole> MentionedRoles => new(this.Json.GetProperty("mention_roles").ToEntityArray<DiscordRole>());
