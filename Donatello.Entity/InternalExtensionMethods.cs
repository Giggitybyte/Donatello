...
internal static class InternalExtensionMethods
{
    ...
    internal static DiscordChannel ToChannelEntity(this JsonElement jsonObject, AbstractBot botInstance)
    {
    ...
    internal static T[] ToEntityArray<T>(this JsonElement jsonArray, AbstractBot botInstance) where T : DiscordEntity
    {
        ...
        { // if we're creating channel entities, create the requested entity instead of using Activator 
