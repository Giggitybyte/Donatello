...
public static class ApplicationEndpoints
{
    ...
    public static JsonElement GetGlobalAppCommandsAsync(this DiscordHttpClient httpClient, ulong applicationId)
    ...
    /// <returns><see href="https://discord.com/developers/docs/interactions/application-commands#application-command-object">application command object</see></returns>
    public static JsonElement GetGlobalAppCommandAsync(this DiscordHttpClient httpClient, ulong applicationId, ulong commandId)
    ...
    public static JsonElement DeleteGlobalAppCommandAsync(this DiscordHttpClient httpClient, ulong applicationId, ulong commandId)
